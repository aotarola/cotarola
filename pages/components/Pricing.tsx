              ...
              <div className="flex-none mt-auto bg-white overflow-hidden shadow p-6">
                ...
                <div className="flex items-center justify-center">
                  <button
                    ...
                    className="mx-auto lg:mx-0 hover:underline gradient text-indigo-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                  >
                    {service.actionText}
                  </button>
                </div>
